 ...
 */
int checkpush(char *lineptr, instruction_t *data,
stack_t **head, int linenumber)
{
char *tokens = NULL;
...
else if (strncmp(tokens, "mod", strlen("mod")) == 0)
{
data->opcode = "mod";
tokens = strtok(NULL, " \n");
if (tokens != NULL)
 ...
 *Return: 0 always success
 */
int checkdisplay(char *lineptr, instruction_t *data,
stack_t **head, int linenumber)
{
char *tokens = NULL;
tokens = strtok(lineptr, " \n");
 ...
 *Return: 0 always success
 */
int checkmunp(char *lineptr, instruction_t *data,
stack_t **head, int linenumber)
{
char *tokens = NULL;
tokens = strtok(lineptr, " \n");
 ...
 *Return: 0 always success
 */
int checkop(char *lineptr, instruction_t *data,
stack_t **head, int linenumber)
{
char *tokens = NULL;
tokens = strtok(lineptr, " \n");
 ...
 *Return: 0 always success
 */
int checkopp(char *lineptr, instruction_t *data,
stack_t **head, int linenumber)
{
char *tokens = NULL;
tokens = strtok(lineptr, " \n");
